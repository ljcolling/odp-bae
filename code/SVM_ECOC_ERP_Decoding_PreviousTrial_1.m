% This function does ERP-based decoding of the previous-trial orientation in Experiment 1.
...
% Gi-Yeul Bae 2018.06.20.

function SVM_ECOC_ERP_Decoding_PreviousTrial_1(subs)
delete(gcp)
parpool
...
for s = 1:nSubs
    ...
    channel = data.channel(1:639); % tip location of sample teardrop of n-1 trial
    ...
    % grab EEG data
    eegs = data.eeg(2:640,ReleventChan,:); % data of n trial (excluding the first trial)
